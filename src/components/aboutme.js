    ...
    return(
        <div style={{textAlign: 'center'}}>
            <Fade cascade>
              ...
              <p className="text"> Hello! I was born in Ahmedabad, India and raised in Mississauga, Ontario and Edmonton, Alberta. I went to various schools, including Meyokumin,
                ...
                understanding the significance and context of major world events, problem-solving math questions, and understand the world through a scientific lens. It gives context of the world we grew up in.
                And with that knowledge, there is a sense of responsibility to leave the world a little better than the state we were given. This means advocating for equal rights, supporting climate change initiatives, and considering the global community we are part of.
              ...
              <p className="text">Some of my hobbies include music, basketball, soccer, web-surfing and travelling. I love trying new things, these include skiing, stargazing, learning new languages, and more!  </p>
