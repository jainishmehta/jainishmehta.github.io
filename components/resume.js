                ...
                <Grid>
                    <Cell col={4}>
                        <div style={{textAlign: 'center'}}>
                            <img className="help"
                                 src={require("C:/Users/jaini/react-portfolio/src/components/astronaut.png")} alt="cannot display"
                            />
                        </div>
                        <Fade top cascade>
                    ...
                    <Cell className="resume-right-col" col={8}>
                        ...
                        <Grid>
                            ...
                            <Cell col={8}>
                                <img className="logo"
                                     src={require("C:/Users/jaini/react-portfolio/src/redcanari.png")} alt="cannot display"
                                />
                        ...
                        <Grid>
                            ...
                            <Cell col={8}>
                                <img className="logo"
                                     src={require("C:/Users/jaini/react-portfolio/src/manulife.png")} alt="cannot display"
                                />
                        ...
                        <Grid>
                            ...
                            <Cell col={8}>
                                <img className="logo"
                                     src={require("C:/Users/jaini/react-portfolio/src/mcss.png")} alt="cannot display"
                                />
                        ...
                        <Grid>
                            ...
                            <Cell col={8}>
                                <img className="logo"
                                     src={require("C:/Users/jaini/react-portfolio/src/cityofedmonton.png")} alt="cannot display"
                                />
